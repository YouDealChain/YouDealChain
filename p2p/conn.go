...
import (
	...
	"github.com/YouDealChain/YouDealChain/p2p/pb"
	"github.com/YouDealChain/YouDealChain/util"
...
func NewConn(stream libp2pnet.Stream, peer *YdcPeer, peerID peer.ID) *Conn {
	return &Conn{
		stream:             stream,
		peer:               peer,
		remotePeer:         peerID,
